    ...
    >
      <div class="w-full max-w-sm">
        ...
        <form class="mt-8 space-y-5" @submit.prevent="onSubmit">
          ...
          <label class="block">
            <span class="mb-1 block text-sm font-medium text-heading">Nueva contraseña</span>
            <input
              v-model="password"
              type="password"
              required
          ...
          <label class="block">
            <span class="mb-1 block text-sm font-medium text-heading">Confirmar contraseña</span>
            <input
